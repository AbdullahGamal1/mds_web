...
const Contact: React.FC = () => {
    const schemas = [
        ...
        getBreadcrumbSchema([
            ...
            { name: 'Contact', url: 'https://mds-solutions.com/contact' }
        ])
    ];
    return (
        <>
            <SEO
                title="Contact Us - MDS Zoho Partner Solutions"
                description="Get in touch with Mashreq Digital Solutions. Located at B115 Smart Village, Giza, Egypt. Call us at +20-115 965 9977 for Zoho CRM, ERP, and digital transformation services."
                keywords="Contact MDS, Zoho Partner Egypt Contact, Smart Village Giza, Zoho Support Egypt, CRM Implementation Contact"
                url="https://mds-solutions.com/contact"
                schema={schemas}
            />
                        ...
                        <div className="bg-primary/10 dark:bg-primary/5 rounded-xl p-6 md:p-8 flex flex-col gap-6 border border-primary/20">
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-[#8a7c60] dark:text-gray-400 mt-1">B115 Smart Village<br />Giza, Egypt</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <a className="text-[#181611] dark:text-white font-semibold hover:text-primary transition-colors" href="tel:+201159659977">+20-115 965 9977</a>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <a className="text-[#181611] dark:text-white font-semibold hover:text-primary transition-colors" href="mailto:info@mds-solutions.com">info@mds-solutions.com</a>
                                </div>
                            </div>
                        </div>
